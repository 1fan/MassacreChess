# The node class is used in minmax implementation.
...
class Node(object):
            ...
            if possible_moves:
                for move in possible_moves:
                    ...
                    self.children.append(Node(self.depth - 1,
                        # invert between 0(black) and 1(white)
                        1 - self.my_color,  
                        child_board,
                        move,
                        self.max_color))
    ...
    def get_e(self, turns):
        ...
        # Moving phase
            ...
            weights = [1, 0.419951280104073, 0.826045902106665, 
            -0.246892542362536, -0.613176001482239]
